...
class Bvt2Mat:
    def __init__(self, dom_filepath:str, sub_filepath:str, min_count:int=1, max_count:int=2):
        ...
        self.behavior_dict = {   # 1-based for mat
            "other": 1,       "dom_in_cage": 2,       "dom_interaction": 3,     "sub_in_cage": 4,       "sub_interaction": 5,}
    ...
    def bvt_to_mat_workflow(self):
        ...
        dm_beh_array = dm_beh_array[0:final_len]
        sb_beh_array = sb_beh_array[0:final_len]
    ...
    def read_bvt_workspace(file_path) -> np.ndarray:
            ...
            if blob_array is not None and np.sum(blob_array) != 0:
                ...
                print("Blob array is empty!")

if __name__ == "__main__":
    project_folder = "D:/DGH/Data/Videos/20250913 Marathon"
    dom_pkl = "301T_aaa_20251030160615_combined_cut_workspace.pkl"
    sub_pkl = "303T_aaa_20251030160615_combined_cut_workspace.pkl"

    b2m = Bvt2Mat(
        dom_filepath=os.path.join(project_folder, dom_pkl),
        sub_filepath=os.path.join(project_folder, sub_pkl),
        )
